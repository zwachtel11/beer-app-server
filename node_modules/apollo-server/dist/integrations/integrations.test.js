    ...
    describe('apolloServer', () => {
        ...
        describe('graphqlHTTP', () => {
            ...
            it('can handle introspection request', () => {
                ...
                const req = request(app)
                    .post('/graphql')
                    .send({ query: graphql_1.introspectionQuery });
                return req.then((res) => {
                    chai_1.expect(res.status).to.equal(200);
                    return chai_1.expect(res.body.data.__schema.types[0].fields[0].name).to.equal('testString');
                });
            });
            ...
            it('sends internal server error when formatError fails', () => {
                ...
                return req.then((res) => {
                    return chai_1.expect(res.res.body.errors[0].message).to.equal('Internal server error');
                });
            });
